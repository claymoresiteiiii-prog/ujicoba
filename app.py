...
if uploaded_file is not None:
    ...
    # ==========================================
    # FITUR BARU: FILTER TAMPILAN GRAFIK (CHECKBOX)
    # ==========================================
    st.sidebar.markdown("---")
    ...
    tampil_prediksi = st.sidebar.checkbox("4. Prediksi Tren Penjualan", value=True)
    ...
    if all(col in df_final.columns for col in required_cols):
        ...
        if df_final.empty:
            ...
            # --- TAMPILKAN JIKA CHECKBOX 1 DICENTANG ---
            ...
            # ==========================================
            # --- TAMPILKAN JIKA CHECKBOX 2 DICENTANG ---
            if tampil_profit:
            ...
            # ==========================================
            # --- TAMPILKAN JIKA CHECKBOX 3 DICENTANG ---
            if tampil_korelasi:
            ...
            # ==========================================
            # --- TAMPILKAN JIKA CHECKBOX 4 DICENTANG ---
            if tampil_prediksi:
